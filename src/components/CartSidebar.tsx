            ...
            {cart.length > 0 && (
              <div className="border-t border-stone px-6 py-5 space-y-4">
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3.5 bg-accent text-white lbl rounded-full hover:bg-accent-dark transition-all duration-300"
                >
                  Checkout →
                </button>
                <button
                  onClick={orderViaWhatsApp}
                  className="w-full flex items-center justify-center gap-2 py-3 bg-[#25D366]/10 text-[#25D366] lbl rounded-full hover:bg-[#25D366] hover:text-white transition-all duration-300 border border-[#25D366]/30"
                >
